...
module.exports = {
    meta: {
        type: "layout",
        docs: {
            description: "Enforce placing object properties on separate lines except screensize object properties.",
            recommended: false,
    ...
    create(context) {
        ...
        return {
            ObjectExpression(node) {
                ...
                if (node.properties.every(prop => ['xs', 'sm', 'md', 'lg', 'xl', 'xxl'].includes(prop.key.name))) {
                    return;
                };
